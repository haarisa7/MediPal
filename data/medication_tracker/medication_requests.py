...
from data.medication_tracker.patient_medications import get_patient_medication_entry_by_id
...
def process_accepted_request(request_id):
    ...
    if details['request_type'] == 'add':
        ...
        from data.medication_tracker.patient_medications import update_patient_medication
